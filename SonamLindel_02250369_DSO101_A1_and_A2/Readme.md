...
The backend was developed using Express.js. The following API routes were implemented:
...
Environment variables were used to store sensitive configuration data instead of hardcoding them into the application. The `.env` file was added to `.gitignore` to prevent sensitive information from being uploaded to GitHub.
...
The frontend was built using React.js. The application interface allows users to:
- Add tasks
- Edit tasks
- Delete tasks
- Toggle task completion

Axios was used to communicate with the backend API. React Hooks such as `useState` and `useEffect` were used to manage application state and fetch tasks from the backend.
...
Docker was used to containerize both the frontend and backend applications. Containerization makes the application portable and easier to deploy across different environments.
...
After building the Docker images, they were pushed to Docker Hub. This allowed the images to be pulled and deployed from anywhere.
...
**Backend Deployment:**
A new Web Service was created using the backend Docker image from Docker Hub. The following environment variables were configured on Render:
- Database credentials
- Server port
- SSL configuration

**Frontend Deployment:**
Another Web Service was created using the frontend Docker image. The frontend was connected to the live backend API using:
```env
REACT_APP_API_URL=[https://be-todo-02250369.onrender.com](https://be-todo-02250369.onrender.com)
```
...
After deployment, the live application was tested thoroughly. The following features were verified:
- Task creation
- Task editing
- Task deletion
...
Several issues were encountered during development and deployment. Some of the main challenges included:
...
This assignment helped me understand many important DevOps and deployment concepts. I learned:
...
## Live Deployments
- **Frontend Deployment:** [https://fe-todo-02250369.onrender.com](https://fe-todo-02250369.onrender.com)
- **Backend Deployment:** [https://be-todo-02250369.onrender.com](https://be-todo-02250369.onrender.com)

## Source Code
- **GitHub Repository:** [https://github.com/sonamlindel19/DSO101_Todo_App](https://github.com/sonamlindel19/DSO101_Todo_App)

## Docker Hub Images
- **Backend Image:** [https://hub.docker.com/r/sonamlindel19/be-todo](https://hub.docker.com/r/sonamlindel19/be-todo)
- **Frontend Image:** [https://hub.docker.com/r/sonamlindel19/fe-todo](https://hub.docker.com/r/sonamlindel19/fe-todo)

---

# Screenshots

![To-Do App Screenshot 1](image.png)
![To-Do App Screenshot 2](image-1.png)
![To-Do App Screenshot 3](image-2.png)
![To-Do App Screenshot 4](image-3.png)